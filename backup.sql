...
CREATE OR REPLACE FUNCTION "public"."handle_new_user"() RETURNS "trigger"
    ...
    AS $$
BEGIN
    INSERT INTO public.profiles (id, full_name, email, role, profile_complete)
    VALUES (
        NEW.id,
...
CREATE POLICY "Users can view their own profile" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "id") OR (EXISTS ( SELECT 1
   FROM "public"."community_members" "cm"
  WHERE (("cm"."profile_id" = "cm"."id") AND ("cm"."community_id" IN ( SELECT "community_members"."community_id"
