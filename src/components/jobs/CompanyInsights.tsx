...
import { Building2, Users, MapPin, Award, TrendingUp, ChevronLeft, ChevronRight, MessageCircle, UserRound, LineChart } from 'lucide-react';
import { MapContainer, TileLayer, Marker, Popup } from 'react-leaflet';
import 'leaflet/dist/leaflet.css';
import L from 'leaflet';
import { CircularProgress } from '../ui/CircularProgress';
import { JOB_TESTIMONIALS } from '../../data/mockJobs';
import type { JobTestimonial, CompanyInsights as CompanyInsightsType } from '../../lib/types/jobs';
...
export function CompanyInsights({ insights, jobTitle, companyName = 'Company' }: CompanyInsightsProps) {
    ...
    <div className="bg-white rounded-xl p-4 md:p-6 space-y-6">
      ...
      {insights.teamPhoto && (
        <div className="space-y-3">
          <h3 className="text-sm font-medium text-gray-700">The team says hi!</h3>
      ...
      {insights.locations && insights.locations.length > 0 && (
        <div className="space-y-3">
          <h3 className="text-sm font-medium text-gray-700">Hiring Locations</h3>
      ...
      {testimonialError ? (
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-700">Employee Testimonials</h3>
          <div className="space-y-4">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-4">
                <p className="text-gray-700 text-sm italic mb-3">"{testimonial.quote}"</p>
                <div className="flex items-center space-x-3" key={`${index}-content`}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <h3 className="text-sm font-medium text-gray-700 col-span-2 mb-2">Key Stats</h3>
        <div className="col-span-2 space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-gray-900">
                <strong className="text-[#DC2626]">Few</strong> candidates hear back within 2 weeks
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-gray-900">
                <strong className="text-[#DC2626]">-9%</strong> employee growth in 12 months
              </span>
            </div>
          </div>
        </div>
      ...
      {insights.awards && insights.awards.length > 0 && (
        <div>
          <h3 className="text-sm font-medium text-gray-700 mb-3">Awards & Recognition</h3>
