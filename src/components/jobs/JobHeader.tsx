...
export function JobHeader({ job }: JobHeaderProps) {
  ...
  const headerStyle = React.useMemo(() => ({
    backgroundColor: colorData?.dominantColor ? hexToRgba(colorData.dominantColor, 0.1) : '#F3F4F6',
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 md:gap-3">
        ...
        <span 
          ...
          style={{ backgroundColor: hexToRgba(companyColor, 0.1), color: companyColor }}
        >
        ...
        {job.salary && (
          ...
          >
            ...
            {job.salary.min/1000}-{job.salary.max/1000}k {job.salary.currency}
          </span>
        )}
