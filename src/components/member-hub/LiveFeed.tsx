...
export function LiveFeed({ styles, compact = true }: LiveFeedProps) {
  ...
  const threads = useMemo(() => [
    ...
    },
    {
      ...
      author: {
        name: 'Sarah Chen',
        avatar: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=48&h=48&fit=crop'
      }
    },
    {
      id: 3,
    ...
    {
      id: 4,
      title: 'France-based Novas: An exclusive invite to the biggest Tech & Retail event on Nov 26-27',
      author: {
        name: 'Marie Laurent',
