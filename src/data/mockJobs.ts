...
export const MOCK_JOBS: Job[] = [
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1573496774426-fe3db3dd1731?q=80&w=3869&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C1
    location: 'London',
    type: 'Full-Time',
    salary: {
      min: 70000,
...
- **Collaborate with senior bankers** to develop strategic solutions for clients.`,
    ...
    sisterScore: 85,
    benefits: [
      { icon: 'health', label: 'Comprehensive Health Insurance', description: 'Full medical, dental, and vision coverage' },
      { icon: 'bonus', label: 'Performance Bonus', description: 'Competitive annual bonus structure' },
      { icon: 'education', label: 'Learning Budget', description: '£5,000 annual education allowance' },
      { icon: 'fitness', label: 'Wellness Program', description: 'Gym membership and wellness activities' }
    ],
    companyInsights: {
      founded: 1869,
      size: '10000+',
      ...
      description: 'Leading global investment banking, securities and investment management firm with a rich history of innovation and market leadership.',
      teamPhoto: {
  ...
  },
  {
    ...
    company: 'Adyen',
    companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Adyen_Corporate_Logo.svg/2560px-Adyen_Corporate_Logo.svg.png',
    coverImage: 'https://images.unsplash.com/photo-1603201667230-bd139210db18?q=80&w=3888&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C2
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 75000,
    ...
    sisterScore: 88,
    benefits: [
      { icon: 'remote', label: 'Hybrid Working', description: 'Flexible work-from-home policy' },
      { icon: 'education', label: 'Learning & Development', description: '€5,000 annual learning budget' },
      { icon: 'travel', label: 'Travel Opportunities', description: 'International office exchanges' },
      { icon: 'health', label: 'Health & Wellness', description: 'Comprehensive health package' }
    ],
    companyInsights: {
      founded: 2006,
      size: '1000+',
      ...
      description: 'Leading global payment technology company revolutionizing the way the world pays and gets paid.',
      teamPhoto: {
  ...
  },
  {
    ...
    company: 'ING Tech',
    companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/ING_Group_N.V._Logo.svg/1280px-ING_Group_N.V._Logo.svg.png',
    coverImage: 'https://images.unsplash.com/photo-1576267423429-569309b31e84?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C3
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 80000,
...
- **Troubleshoot and resolve technical issues** related to blockchain integrations.`,
    ...
    sisterScore: 82,
    benefits: [
      { icon: 'education', label: 'Certification Support', description: 'Full coverage for blockchain certifications' },
      { icon: 'remote', label: 'Flexible Working', description: '3 days remote, 2 days office' },
      { icon: 'bonus', label: 'Innovation Bonus', description: 'Rewards for patent filings' },
      { icon: 'health', label: 'Health Coverage', description: 'International health insurance' }
    ],
    companyInsights: {
      founded: 1991,
      size: '5000+',
      ...
      description: 'Leading European bank\'s technology division focusing on innovative financial solutions and digital transformation.',
      teamPhoto: {
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1651094895186-9b2dca7c0b59?q=80&w=3869&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C4
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 85000,
...
- **Stay abreast of the latest advancements** in data science and apply best practices to projects.`,
    ...
    sisterScore: 90,
    benefits: [
      { icon: 'education', label: 'Conference Budget', description: '€10,000 annual conference attendance' },
      { icon: 'remote', label: 'Remote First', description: 'Work from anywhere in Europe' },
      { icon: 'bonus', label: 'Stock Options', description: 'Competitive equity package' },
      { icon: 'fitness', label: 'Wellness Package', description: 'Mental and physical health support' }
    ],
    companyInsights: {
      founded: 2004,
      size: '500+',
      ...
      description: 'Leading European payment service provider focusing on simplifying complex financial services.',
      teamPhoto: {
  ...
  },
  {
    ...
    companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/0/08/Flow_Traders_logo.svg',
    coverImage: 'https://images.unsplash.com/photo-1670851810697-68ddb4ecae1c?q=80&w=3682&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C5
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 90000,
...
- **Present research findings and strategy performance** to stakeholders.`,
    ...
    sisterScore: 85,
    benefits: [
      { icon: 'bonus', label: 'Performance Bonus', description: 'Uncapped bonus potential' },
      { icon: 'education', label: 'Research Budget', description: 'Access to academic resources and conferences' },
      { icon: 'health', label: 'Premium Healthcare', description: 'International health coverage' },
      { icon: 'fitness', label: 'Sports Facilities', description: 'On-site gym and sports activities' }
    ],
    companyInsights: {
      founded: 2004,
      size: '500+',
      ...
      description: 'Global technology-enabled liquidity provider specializing in exchange traded products.',
      teamPhoto: {
  ...
  },
  {
    ...
    company: 'ABN AMRO',
    companyLogo: 'https://play-lh.googleusercontent.com/qI_TUIRUO7VeW3x-Cf4u6tP3fIOLyRjstgNtO4fuJ64RzlbV12HnZ7p96oOrsukRLSw',
    coverImage: 'https://images.unsplash.com/photo-1590650213165-c1fef80648c4?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // C6
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 75000,
...
- **Analyze risk data and generate reports** for senior management and regulatory bodies.`,
    ...
    sisterScore: 87,
    benefits: [
      { icon: 'education', label: 'Professional Development', description: 'Full support for risk certifications' },
      { icon: 'remote', label: 'Hybrid Working', description: 'Flexible work arrangement' },
      { icon: 'bonus', label: 'Annual Bonus', description: 'Performance-based bonus structure' },
      { icon: 'health', label: 'Healthcare', description: 'Comprehensive health package' }
    ],
    companyInsights: {
      founded: 1824,
      size: '10000+',
      ...
      description: 'Leading Dutch bank with a strong focus on sustainability and digital innovation in financial services.',
      teamPhoto: {
  ...
  },
  {
    ...
    companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Booking.com_logo.svg/2560px-Booking.com_logo.svg.png',
    coverImage: 'https://images.unsplash.com/photo-1550071593-fd1bdaf1f93c?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // U1 reused as cover
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 80000,
...
- **Ensure the security and integrity of compliance data** through best practices and regular audits.`,
    ...
    sisterScore: 89,
    benefits: [
      { icon: 'travel', label: 'Travel Benefits', description: 'Annual travel allowance' },
      { icon: 'remote', label: 'Remote Work', description: 'Global remote work options' },
      { icon: 'education', label: 'Learning Budget', description: '€7,500 annual development budget' },
      { icon: 'health', label: 'Health & Wellness', description: 'Comprehensive benefits package' }
    ],
    companyInsights: {
      founded: 1996,
      size: '5000+',
      ...
      description: 'Global leader in online travel expanding into innovative financial services solutions.',
      teamPhoto: {
  ...
  },
  {
    ...
    company: 'Rabobank',
    companyLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/54/Rabobank_logo.svg/1200px-Rabobank_logo.svg.png',
    coverImage: 'https://images.unsplash.com/photo-1590650486895-79681b6f26a7?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // U3 reused as cover
    location: 'Amsterdam',
    type: 'Full-Time',
    salary: {
      min: 70000,
...
- **Oversee the product lifecycle** from ideation to launch, including user testing and feedback integration.`,
    ...
    sisterScore: 86,
    benefits: [
      { icon: 'education', label: 'Training Budget', description: '€5,000 annual learning allowance' },
      { icon: 'remote', label: 'Hybrid Work', description: 'Flexible working arrangements' },
      { icon: 'bonus', label: 'Innovation Bonus', description: 'Rewards for successful initiatives' },
      { icon: 'health', label: 'Wellness Package', description: 'Complete health coverage' }
    ],
    companyInsights: {
      founded: 1895,
      size: '10000+',
      ...
      description: 'Leading Dutch cooperative bank focusing on sustainable banking and agricultural innovation.',
      teamPhoto: {
  ...
  'FinTech Product Manager': [
    {
      ...
      quote: 'Working at Adyen has been transformative for my career. The level of innovation and impact you can have here is unmatched.'
    },
    {
      name: 'Mark Thompson',
      title: 'Product Lead',
      avatar: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?w=120&h=120&fit=crop',
      quote: 'The culture of innovation and continuous learning makes this a fantastic place for product managers to grow.'
    }
  ],
  'Blockchain Developer': [
    {
      ...
      quote: 'ING Tech offers an incredible environment for blockchain innovation. The support for new ideas is remarkable.'
    },
    {
      name: 'Alex Kumar',
      title: 'Senior Developer',
      avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=120&h=120&fit=crop',
      quote: 'The blockchain team here is working on cutting-edge projects that are reshaping the future of banking.'
    }
  ]
};
