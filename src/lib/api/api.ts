...
export const communityApi = {
  getCommunity: (slug: string) => fetchApi<Community>(`/communities/${slug}`),
...
export const employersApi = {
  ...
  approveCompany: (communityId: string, companyId: string) =>
    fetchApi<void>(
      `/communities/${communityId}/companies/${companyId}/approve`,
      {
        method: 'POST',
      }
    ),
  ...
  updateCompanyStatus: (
    ...
    fetchApi<Company>(
      `/communities/${communityId}/companies/${companyId}/status`,
      {
        method: 'PATCH',
