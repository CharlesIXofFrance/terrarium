...
const MOCK_JOBS = [
  {
    ...
    description: 'Join our dynamic VC team focusing on AgriFood tech investments.',
  ...
  },
  {
    ...
    description: 'Exciting opportunity to work with one of the largest investment management firms.',
  ...
  },
  {
    ...
    experience: '3-5 Years of Experience',
    description: 'Join our growing consulting practice specializing in digital transformation.',
